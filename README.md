# HotMaps-building\_h-c\_default\_EU28 Docker image
...
`docker build -t hotmaps/building_h-c_default_EU28 .`
...
`docker run -d -v "`*absolute/path/to/your/code*`:/data" -p 8181:80 -it hotmaps/building_h-c_default_EU28`
